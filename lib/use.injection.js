 ...
 * @param { object } [opts] The `useInjection` additional options as object
 ...
 * @return { InjectedFn }
 */
const useInjection = (fn, opts) => async function (...args) {
...
const useTwilioImport = (objectThis) => (
  type, name, path,
) => async function (...args) {
  ...
  return file[name].bind({ twilio: objectThis.twilio, env: objectThis.env })(...args);
};
...
module.exports = { useInjection, useTwilioImport, TWILIO_TYPES };
